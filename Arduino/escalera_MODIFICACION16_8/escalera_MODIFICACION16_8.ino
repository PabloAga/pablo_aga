...
void loop()  
{
  ...
  delay(150);
  int valueP1= digitalRead(M1); //LEO EL VALOR DEL PULSADOR 1
    if(valueP1 == LOW)//CONDICION SI SE toca EL PULSADOR 1
     {
      delay(200);
 ...
 /*>=POR== */  if(y==1){ //CONDICION PARA EL CASO QUE DETECTO EL PIR2 SALGA DEL BUCLE DEL RETARDO DEL PIR1
                  f=(diferenciaTiempo)+1;
                  z=1;//CONDICION PARA NO ENTRAR AL BUCLE CUANDO DETECTA pir2 YA QUE ANTERIORMENTE DETECTO
                 }
            }
              if(z<1)
              {
                ...
                while(r<=diferenciaTiempo)
                  {
                    ...
                    delay(1);
                    r=r+1;
                    if(q>=1)//CONDICION PARA EL CASO QUE DETECTO EL PIR2 SALGA DEL BUCLE DEL RETARDO DEL PIR1
                      {
                         r=diferenciaTiempo+1;
                      }
                  }
 ...
 //PULSADOR2
  ...
  int valuenP2= digitalRead(M2);
  if(valuenP2 == LOW)//CONDICION SI SE APRETO EL PULSADOR 2
    {
      delay(200);
      tiempo1 = millis();  //TOMA EL TIEMPO DESDE QUE SE ENCENDIO EL ARDUINO 
      x=0;
              ...
              while(t<=diferenciaTiempo)
                {
                  ...
                  delay(1);
                  t=t+1;
/*>=POR== */      if(e==1){ //CONDICION PARA EL CASO QUE DETECTO EL PIR2 SALGA DEL BUCLE DEL RETARDO DEL PIR1
                    t=(diferenciaTiempo)+1;
                    u=1;//CONDICION PARA NO ENTRAR AL BUCLE CUANDO DETECTA pir2 YA QUE ANTERIORMENTE DETECTO
                  }
               }
             if(u<1)
              {
 ...
 //infrarrojo 1
  ...
  b=0, e=0, f=0, h=0, q=0, t=0, r=0, u=0, w=0, x=0, y=0, z=0;
  delay(100);
}
